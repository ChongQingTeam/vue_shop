  ...
  <div>
    <el-card>
      ...
      <el-table :data = "orderList" border stripe max-height = "500">
        ...
        <el-table-column label = "配置名称" prop = "order_number"></el-table-column>
        <el-table-column label = "爬取地址" prop = "order_price"></el-table-column>
        <el-table-column label = "爬取方式" v-slot="scope">
          <el-tag type="danger" v-if="scope.row.pay_status==='0'">selenium</el-tag>
          <el-tag type="success" v-else>未完待续</el-tag>
        </el-table-column>
